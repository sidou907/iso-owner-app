...
* `iso_owner_app` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `iso-owner-app` - executable or bundle name on disk.
* `iso-owner-app` - display name shown in window titles and about app dialogs.
